...
namespace Kvasir {
namespace USB { namespace detail {
    ...
    namespace Descriptors {
        ...
        namespace detail {
            ...
            constexpr auto generateArray(Ts const&... args) {
                ...
                ((pos
                  = std::copy_n(std::bit_cast<std::array<std::byte, sizeof(args)>>(args).begin(),
                                sizeof(args),
                                pos)),
                 ...);
                return buffer;
    ...
    namespace SimpleBulk { namespace Descriptors {
        ...
        consteval auto makeInterfaceDescriptorArrays() {
            constexpr USB::Descriptors::Interface InterfaceDescriptor{.bInterfaceNumber{0},
                                                                      .bAlternateSetting{0},
                                                                      .bNumEndpoints{2},
                                                                      .bInterfaceClass{255},
    ...
    namespace CDC {
        ...
        namespace Descriptors {
            ...
            struct CallManagement
              : detail::InterfaceDescriptorBase<CallManagement,
                                                DescriptorSubType::CDC_CallManagement> {
        ...
        namespace ACM { namespace Descriptors {
            ...
            template<std::uint8_t ManagementEndpointId,
            ...
            consteval auto makeInterfaceDescriptorArrays() {
                ...
                constexpr USB::CDC::Descriptors::Union CDC_UnionDescriptor{.bMasterInterface0{0},
                                                                           .bSlaveInterface0{1}};
                ...
                constexpr USB::Descriptors::Endpoint CDC_ManagementEndpointDescriptor{
                  .bEndpointAddress{
                    makeEndpointAddress(EndpointDirection::In, ManagementEndpointId)},
    ...
    namespace detail {
        ...
        struct USBBase {
            ...
            static void onIsr() {
                auto const status = apply(read(Regs::INTS::setup_req),
            ...
            static constexpr auto initStepInterruptConfig
              = list(Kvasir::Nvic::makeSetPriority<0>(InterruptIndexes),
            ...
            static constexpr auto runtimeInit = []() {
                std::memset(reinterpret_cast<void*>(BufferRegs::baseAddr), 0, 4096);
                ...
                if(in) {
                    if(shouldSetAddress) {
                        ...
                        if constexpr(Child::ConfigDescriptor.size() > 64) {
                            if(secondConfig) {
                                secondConfig = false;
                                ep0IN(std::span{Child::ConfigDescriptor.begin() + 64,
            ...
            static void handleBufferDone(std::size_t ep_num,
                                         bool        in) {
                UC_LOG_T("buffer done ep: {} dir: {}", ep_num, in);
                if(ep_num == 0) {
                    ep0Handler(in);
                } else {
            ...
            template<std::size_t EP,
                     std::size_t Buffer>
            static void startINTransfer(std::span<std::byte const> data,
                                        bool                       pid) {
            ...
            template<std::size_t EP,
                     std::size_t Buffer>
            static void startOUTTransfer(std::size_t size,
                                         bool        pid) {
                static_assert(Buffer == 1 || Buffer == 0, "only dual buffered");
                assert(64 >= size);
            ...
            static void handleConfigDescriptor(Kvasir::USB::SetupPacket const& pkt) {
                if(pkt.wLength >= Child::ConfigDescriptor.size()) {
                    if constexpr(Child::ConfigDescriptor.size() > 64) {
                        secondConfig = true;
                        ep0IN(std::span{Child::ConfigDescriptor.begin(),
            ...
            static void handleSetupPacket(Kvasir::USB::SetupPacket const& pkt) {
                ...
                case Kvasir::USB::SetupPacket::Recipient::device:
                    {
                    ...
                    break;
                case Kvasir::USB::SetupPacket::Recipient::interface:
                    {
                        Child::SetupPacketInterface(pkt);
                    }
                    break;
                case Kvasir::USB::SetupPacket::Recipient::endpoint:
                    {
                        Child::SetupPacketEndpoint(pkt);
                    }
                    break;

                case Kvasir::USB::SetupPacket::Recipient::other:
                    {
                        UC_LOG_W("foo");
                    }
                    break;
    ...
    struct USB_CDC_ACM : detail::USBBase<Clock, USB_CDC_ACM<Clock, Config>, Config> {
        ...
        static constexpr auto DeviceDescriptor{
          Kvasir::USB::CDC::ACM::Descriptors::makeDeviceDescriptorArray<Config::ProductVersionBCD,
                                                                        Config::VendorID,
                                                                        Config::ProductID,
                                                                        1,
                                                                        2,
        ...
        static constexpr auto ConfigDescriptor{Kvasir::USB::Descriptors::makeConfigDescriptorArray(
          ...
          Kvasir::USB::Descriptors::Interface{.bInterfaceNumber   = 2,
                                              .bAlternateSetting  = 0,
                                              .bNumEndpoints      = 0,
                                              .bInterfaceClass    = 255,
                                              .bInterfaceSubClass = 0,
        ...
        static void epHandler(std::size_t epNum,
                              bool        in) {
            if(epNum == 2 && in) {
                sendNext();
            } else if(epNum == 2 && !in) {
        ...
        static constexpr USB::CDC::LineCoding lineCoding{};
        ...
        static void SetupPacketInterface(Kvasir::USB::SetupPacket const& pkt) {
                      ...
                      && (pkt.bRequest == Kvasir::USB::SetupPacket::Request::getLineCoding))
            {
                ...
                Base::ep0IN(std::as_bytes(std::span{std::addressof(lineCoding), 1}));
            } else if(pkt.wIndex == 0
                      && pkt.direction() == Kvasir::USB::SetupPacket::Direction::hostToDevice
    ...
    struct USB_Bulk : detail::USBBase<Clock, USB_Bulk<Clock, Config>, Config> {
        ...
        static constexpr auto DeviceDescriptor{
          Kvasir::USB::SimpleBulk::Descriptors::makeDeviceDescriptorArray<Config::ProductVersionBCD,
                                                                          Config::VendorID,
                                                                          Config::ProductID,
                                                                          1,
                                                                          2,
        ...
        static constexpr auto ConfigDescriptor{Kvasir::USB::Descriptors::makeConfigDescriptorArray(
          500,
          std::get<0>(InterfaceDescriptors),
          Kvasir::USB::Descriptors::Interface{.bInterfaceNumber   = 1,
                                              .bAlternateSetting  = 0,
                                              .bNumEndpoints      = 0,
                                              .bInterfaceClass    = 255,
                                              .bInterfaceSubClass = 0,
        ...
        static void ep0HandlerOut() { UC_LOG_D("unexpected EP0 OUT in bulk mode"); }
