...
namespace Kvasir { namespace USB { namespace detail {
              ...
              []<std::size_t I,
                 ...
                 class Mixin>() {
                  using InstantiatedMixin = Mixin<
                    ...
                    Derived,
                    BaseInterface
                      + MixinTraits::getInterfaceOffset<Clock, Config, Derived, Mixins...>(I),
                    BaseEndpoint
                      + MixinTraits::getEndpointOffset<Clock, Config, Derived, Mixins...>(I)>;
    ...
    struct MixinTraits::MixinBases<Clock,
      ...
      : Mixins<
          ...
          BaseEndpoint + MixinTraits::getEndpointOffset<Clock, Config, Derived, Mixins...>(Is)>... {
