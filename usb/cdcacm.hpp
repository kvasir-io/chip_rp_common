...
namespace Kvasir { namespace USB { namespace CDC {
    ...
    namespace ACM {
        ...
        private:
            ...
            using DataEndpointHandler
              = SendRecvImpl<Clock, Config, Derived, Self, DataEndpointNumber>;
            ...
            static bool EndpointHandlerCallback(std::size_t epNum,
                ...
                if(epNum == 0 && !in && should_handle_line_coding) {
                    ...
                    if(Derived::ep0OUTGetData(tempBuffer)) {
                        ...
                        std::memcpy(std::addressof(lineCoding),
                                    tempBuffer.data(),
                                    tempBuffer.size());
                        Derived::acknowledgeSetupRequest();
                        UC_LOG_I(
